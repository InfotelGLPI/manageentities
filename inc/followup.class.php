...
class PluginManageentitiesFollowUp extends CommonDBTM {
   ...
   function showCriteriasForm($options = array()) {
      ...
      if ($_SESSION['glpiactiveprofile']['interface'] == 'central') {
         ...
         echo "<td class='left'>";
         Html::showDateFormItem("begin_date_after", $options['begin_date_after']);
         echo "</td>";
         echo "<td class='left'>" . __('Begin date') . " " .
              __('of period of contract', 'manageentities') . ", " . __('before') . "</td>";
         echo "<td class='left'>";
         Html::showDateFormItem("begin_date_before", $options['begin_date_before']);
         echo "</td>";
         echo "</tr>";
         ...
         echo "<td class='left'>" . __('End date') . " " .
              __('of period of contract', 'manageentities') . ", " . __('after') . "</td>";
         echo "<td class='left'>";
         Html::showDateFormItem("end_date_after", $options['end_date_after']);
         echo "</td>";
         echo "<td class='left'>" . __('End date') . " " .
              __('of period of contract', 'manageentities') . ", " . __('before') . "</td>";
         echo "<td class='left'>";
         Html::showDateFormItem("end_date_before", $options['end_date_before']);
         echo "</td>";
         echo "</tr>";
