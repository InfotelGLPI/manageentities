                ...
                foreach ($iteratorc as $dataContract) {
                   ...
                   if (isset($options['end_date_before']) && $options['end_date_before'] != '') {
                    ...
                    if ($nbContractDay > 0) {
                        ...
                        $list[$num]['management'] = PluginManageentitiesContract::getContractManagement(
            ...
            foreach ($list as $v => $contract) {
                ...
                if (is_numeric($v)) {
                    ...
                    if ($output_type == Search::HTML_OUTPUT && Session::getCurrentInterface() == 'central') {
                        if ($entity_id != $contract['entities_id']) {
                            ...
                            echo Search::showHeaderItem(
                                ...
                                0,
                                '',
                                $colspanContract . " style='" . PluginManageentitiesMonthly::$style[0] . "' "
                            );
                            echo Search::showEndLine($output_type);
                        }
                    }
                    ...
                    if (Session::getCurrentInterface() == 'central') {
                        ...
                        if ($config->fields['hourorday'] == PluginManageentitiesConfig::HOUR) {
                            if ($output_type != Search::HTML_OUTPUT) {
                                ...
                                echo Search::showItem(
                                    $output_type,
                                    PluginManageentitiesContract::getContractType($contract['contract_type']),
                                    $item_num,
                                    $row_num
                                );
                            } else {
                                ...
                                echo Search::showItem(
                                    ...
                                    '<b>' . __(
                                        ...
                                        'manageentities'
                                    ) . ' : </b>' . PluginManageentitiesContract::getContractType(
                    ...
                    echo Search::showHeaderItem(
                        ...
                        0,
                        '',
                        " $colspanNoprice style='" . PluginManageentitiesMonthly::$style[1] . "'"
                    );
                    ...
                    if ($config->fields['hourorday'] == PluginManageentitiesConfig::HOUR)// Coslpan if type = Hourly
                    {
                        echo Search::showHeaderItem(
                            ...
                            0,
                            '',
                            "colspan='2' style='" . PluginManageentitiesMonthly::$style[1] . "'"
                        );
                    } else {
                        echo Search::showHeaderItem(
                            $output_type,
                    ...
                    foreach ($contract['days'] as $w => $day) {
                        ...
                        echo PluginManageentitiesFollowUp::showNewLine(
                            $output_type,
                            false,
                        ...
                        if ($config->fields['hourorday'] == PluginManageentitiesConfig::DAY) {
                            echo Search::showItem(
                                $output_type,
                                PluginManageentitiesContract::getContractType($day['contract_type']),
                                $item_num,
                                $row_num,
                                "colspan='2' "
                            );
                        ...
                        if (Session::getCurrentInterface() == 'helpdesk'
                            ...
                            if (Session::getCurrentInterface(
                                ) == 'central' || $day['contract_type'] != PluginManageentitiesContract::CONTRACT_TYPE_FORFAIT) {
                                echo Search::showItem(
                                    $output_type,
                    ...
                    if (Session::getCurrentInterface() == 'central') {
                        if ($output_type == Search::HTML_OUTPUT) {
                            ...
                            echo Search::showItem(
                                ...
                                $item_num,
                                $row_num,
                                "$colspanTotal style='" . PluginManageentitiesMonthly::$style[0] . "'"
                            );
                            echo Search::showEndLine($output_type);
                        }
