...
abstract class CommonGLPIModel{
    ...
    *    $errors = array(
    *       CommonGLPIErrors::ERROR_ENTITY   => CommonGLPIErrors::ERROR_ADD,                       // In case of an error when trying to insert a new entity
    *       CommonGLPIErrors::ERROR_CONTRACT => CommonGLPIErrors::ERROR_UPDATE,                    // In case of an error when trying to update a contract
    *       CommonGLPIErrors::ERROR_PERIOD   => array (CommonGLPIErrors::ERROR_UPDATE => 2),       // In case of an error when trying to update the period
