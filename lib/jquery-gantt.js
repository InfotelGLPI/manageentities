            ...
            navigation: function (element) {
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        .append($('<div class="nav-slider" />')
                            .append($('<div class="nav-slider-left" />')
                                .append($('<button type="button" class="fn-nav-link nav-page-back"/>')
                                    .html('&lt;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="fn-nav-link nav-page-next"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        core.navigatePage(element, 1);
                                    }))
                                .append($('<button type="button" class="fn-nav-link nav-now"/>')
                                    .html('&#9679;')
                                    .click(function () {
                                        core.navigateTo(element, 'now');
                                    }))
                                .append($('<button type="button" class="fn-nav-link nav-prev-week"/>')
                                    .html('&lt;&lt;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="fn-nav-link nav-prev-day"/>')
                                    .html('&lt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                            ...
                            .append($('<div class="nav-slider-right" />')
                                .append($('<button type="button" class="fn-nav-link nav-next-day"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -4);
                            ...
                            .append($('<button type="button" class="fn-nav-link nav-next-week"/>')
                                    .html('&gt;&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -8);
                                ...
                                .append($('<button type="button" class="fn-nav-link nav-zoomIn"/>')
                                    .html('&#43;')
                                    .click(function () {
                                        core.zoomInOut(element, -1);
                                    }))
                                .append($('<button type="button" class="fn-nav-link nav-zoomOut"/>')
                                    .html('&#45;')
                                    .click(function () {
                                        core.zoomInOut(element, 1);
                                    }))
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        ...
                        .append($('<button type="button" class="fn-nav-link nav-begin"/>')
                            .html('&#124;&lt;')
                            .click(function () {
                        ...
                        .append($('<button type="button" class="fn-nav-link nav-end"/>')
                            .html('&gt;&#124;')
                            .click(function () {
