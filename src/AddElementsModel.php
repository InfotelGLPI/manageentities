...
use Document;
use DocumentType;
use CommonGLPIDBOperation;
use CommonGLPIElementType;
use CommonGLPIErrors;
use CommonGLPIMessages;
use CommonGLPIModel;
use CommonGLPIStatus;
use Session;
...
{
    public const ERROR_ENTITY = 0;
    public const ERROR_CONTACT = 1;
    public const ERROR_CONTRACT = 2;
    public const ERROR_CONTRACT_MANAGEMENT_TYPE = 2;
    public const ERROR_INTERVENTION = 3;
    public const ERROR_FIELDS = 4;
    public const ERROR_CRIPRICE = 5;
    public const ERROR_NAME_EXIST = 'name_exist';
    public const ERROR_ADD_PDF = 'error_add_pdf';
    public const ERROR_CRIPRICE_EXIST = 'error_criprice_exist';
...
class ElementType extends CommonGLPIElementType
{
    ...
    public const CONTRACT_MANAGEMENT_TYPE = 'contract_management_type';
    public const INTERVENTION = 'intervention';
    public const CRIPRICE = 'criprice';
    public const ALL = 'all_elements';
...
class Status extends CommonGLPIStatus
{
    ...
    public const PDF_ADDED = 'pdf_added';
    public const PDF_NOT_ADDED = 'pdf_not_added';
...
class Action
{
    public const ADD_ONLY_ENTITY = 'add_only_entity';
    public const ADD_ONLY_CONTACT = 'add_only_contact';
    public const ADD_ONLY_CONTRACT = 'add_only_contract';
    public const ADD_ONLY_INTERVENTION = 'add_only_intervention';
    public const ADD_ENTITY_AND_CONTACT = 'add_entity_and_contact';
    public const ADD_ENTITY_AND_CONTRACT = 'add_entity_and_contract';
    public const ADD_ENTITY_AND_INTERVENTION = 'add_entity_and_intervention';
    public const ADD_ENTITY_INTERVENTION_AND_CONTRACT = 'add_entity_intervention_and_contract';
    public const ADD_INTERVENTION_AND_CONTRACT = 'add_intervention_and_contract';
    public const DELETE_CONTRACT_MANAGEMENT_TYPE = 'delete_contract_management_type';
    public const CONFIRM_DELETE_CONTRACT_MANAGEMENT_TYPE = 'confirm_delete_contract_management_type';
    public const ADD_CONTRACT_MANAGEMENT_TYPE = 'add_contract_management_type';
    public const ADD_NEW_CONTACT = 'add_new_contact';
    public const ADD_NEW_INTERVENTION = 'add_new_intervention';
    public const LOAD_CONTRACT_TEMPLATE = 'load_contract_template';
    public const UPDATE_CRI_PRICE = 'update_cri_price';
    public const UPDATE_CONTRACT_LIST = 'update_contract_list';
    public const ADD_NEW_CONTRACT_PDF = 'add_new_contract_pdf';
    public const REINIT_FORMS = 'reinit_forms';
    public const CONFIRM_ADD_ALL_ELEMENT = 'confirm_add_all_element';
    public const CONFIRM_UPDATE_ALL_ELEMENT = 'confirm_update_all_element';
    public const ADD_ALL_ELEMENT = 'add_all_element';
    public const UPDATE_ALL_ELEMENT = 'update_all_element';
    public const SHOW_FORM_CRI_PRICE = 'show_form_cri_price';
    public const ADD_CRI_PRICE = 'add_cri_price';
    public const DELETE_CRI_PRICE = 'delete_cri_price';
    public const UPDATE_CRI_PRICE_FROM_TYPE = 'update_criprice_from_critype';

}

class AddElementsModel extends CommonGLPIModel
{
    ...
    {
        if (is_null(self::$instance) && !isset(
            $_SESSION[AddElementsModel::getType() . '_instance']
        )) {
            self::$instance = new AddElementsModel();
            $_SESSION[AddElementsModel::getType() . '_instance'] = serialize(self::$instance);
        } else {
            self::$instance = unserialize($_SESSION[AddElementsModel::getType() . '_instance']);
        }
    ...
    private function __construct()
    {
        ...
        $contractManagementType = new Contract();
        ...
        $this->messages = [
            ElementType::ENTITY => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new entity fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the entity.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_NAME_EXIST => "<span style='color:red;'> " . __(
                    "Entity name already exists.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the entity.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::CONTACT => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new contact fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the contact.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the contact.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::CONTRACT => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new contract fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the contract.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD_PDF => "<span style='color:red;'> " . __(
                    "An error happend while uploading the document.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_NAME_EXIST => "<span style='color:red;'> " . __(
                ...
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the contract.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::CONTRACT_MANAGEMENT_TYPE => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new contract management type fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the contract management type.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_NAME_EXIST => "<span style='color:red;'> " . __(
                    "Contract management type name already exists.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the contract management type.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_DELETE => "<span style='color:red;'> " . __(
                    "An error happend while deleting the contract management type.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::CRIPRICE => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the price.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the price.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_DELETE => "<span style='color:red;'> " . __(
                    "An error happend while deleting the price.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::INTERVENTION => [
                Errors::ERROR_FIELDS => "<span style='color:red;'> " . __(
                    "All new intervention fields are not filled.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the intervention.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the intervention.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::ALL => [
                ...
                Errors::ERROR_ADD => "<span style='color:red;'> " . __(
                    "An error happend while saving the informations.",
                    "manageentities"
                ) . "</span>",
                Errors::ERROR_UPDATE => "<span style='color:red;'> " . __(
                    "An error happend while updating the informations.",
                    "manageentities"
                ) . "</span>",
            ...
            ElementType::ENTITY . ElementType::CONTACT => [
                Status::ADDED => __(
                    "Entity and contact successfully added",
                    "manageentities"
                ),
            ],
            ElementType::ENTITY . ElementType::CONTRACT => [
                Status::ADDED => __(
                    "Entity and contract successfully added",
                    "manageentities"
                ),
            ],
            ElementType::ENTITY . ElementType::INTERVENTION => [
                Status::ADDED => __(
                    "Entity and intervention successfully added",
                    "manageentities"
                ),
            ],
            ElementType::CONTRACT . ElementType::INTERVENTION => [
                Status::ADDED => __(
                    "Contract and intervention successfully added",
                    "manageentities"
                ),
            ],
            ElementType::ENTITY . ElementType::CONTRACT . ElementType::INTERVENTION => [
                Status::ADDED => __(
                    "Entity, intervention and contract successfully added",
                    "manageentities"
                ),
            ],
    ...
    {
        unset($_SESSION[AddElementsModel::getType() . '_instance']);
        self::$instance = new AddElementsModel();
        $_SESSION[AddElementsModel::getType() . '_instance'] = serialize(self::$instance);
    }
    ...
    {
        $_SESSION[AddElementsModel::getType() . "_instance"] = serialize($this);
    }
    ...
    public function addEntityToBase($pView)
    {
        ...
        if (isset($entity->fields['id']) && $entity->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::UPDATED]) && $datas[Status::UPDATED] == "true") {
                ...
                $pView->updateImgTabTitle(
                    "'img_" . $entity->getType() . "1'",
                    $this->getMessage(ElementType::ENTITY, Status::SAVED, false)
                );
    ...
    public function addContractToBase($pView)
    {
        ...
        if (isset($contract->fields['id']) && $contract->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::ADDED]) && $datas[Status::ADDED] == "true") {
                ...
                $pView->changeBtnName("btnAddContract", __("Update this contract only", "manageentities"));
                $this->setContract($contract);
                $strTitleTab = $contract->fields['name'] ?? "";
                $pView->updateTabTitle(
                    1,
                    $strTitleTab,
                    "div#mytabscontract",
        ...
        if (isset($contractManagementType->fields['id']) && $contractManagementType->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::ADDED]) && $datas[Status::ADDED] == "true") {
                ...
                if (isset($datas['cause'])) {
                    ...
                    switch ($datas['cause']) {
                        case Errors::ERROR_NAME_EXIST:
                            $arrayRes['message'] = $this->getMessage(
                                ElementType::CONTRACT_MANAGEMENT_TYPE,
                                Errors::ERROR_NAME_EXIST
                            );
                            break;
                        default:
                            $arrayRes['message'] = $this->getMessage(
    ...
    public function addContactToBase($pView, $idContact = -1)
    {
        ...
        if (isset($contact->fields['id']) && $contact->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::UPDATED]) && $datas[Status::UPDATED] == "true") {
                ...
                $pView->updateTabTitle(
                    $_POST['fakeid_new_contact'],
                    $strTitleTab,
                    "div#mytabscontacts",
                    $contact,
                    $this->getMessage(ElementType::CONTACT, Status::SAVED)
                );
                //                  $pView->updateImgTabTitle(false,"img_".$contact->getType().$_POST['fakeid_new_contact'],$this->getMessage("contact_saved_db"));
                $pView->changeBtnName(
                    "btnAddContact" . $_POST['fakeid_new_contact'],
                    __("Update this contact only", "manageentities")
                );
                return [
                    "result" => Status::UPDATED,
            ...
            if (isset($datas[Status::ADDED]) && $datas[Status::ADDED] == "true") {
                ...
                if (isset($datas[Status::ADDED]) && $datas[Status::ADDED] == "true") {
                    ...
                    $pView->updateImgTabTitle(
                        "'img_" . $contact->getType() . $_POST['fakeid_new_contact'] . "'",
                        $this->getMessage(ElementType::CONTACT, Status::SAVED),
                        false
                    );
    ...
    public function addInterventionToBase($pView, $idIntervention = -1)
    {
        ...
        if ($cpt == 2) {
            return [
                "result" => Action::ADD_ENTITY_AND_CONTRACT,
        ...
        if (isset($intervention->fields['id']) && $intervention->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::UPDATED]) && $datas[Status::UPDATED] == "true") {
                ...
                $pView->updateImgTabTitle(
                    "'img_" . $intervention->getType() . $_POST['fakeid_new_intervention'] . "'",
                    $this->getMessage(ElementType::INTERVENTION, Status::NOT_SAVED),
                    false
                );
                ...
                $pView->updateTabTitle(
                    ...
                    $strTitleTab,
                    "div#mytabsinterventions",
                    $intervention,
                    $this->getMessage(ElementType::INTERVENTION, Status::SAVED)
                );
                $pView->updateImgTabTitle(
                    "'img_" . $intervention->getType() . $_POST['fakeid_new_intervention'] . "'",
                    $this->getMessage(ElementType::INTERVENTION, Status::SAVED),
                ...
                $pView->changeBtnName(
                    "btnAddIntervention" . $_POST['fakeid_new_intervention'],
                    __("Update this intervention only", "manageentities")
                );
    ...
    public function addCripriceToBase($pView, $tabIdIntervention, $typeIntervention)
    {
        ...
        if (isset($criPrice->fields['id']) && $criPrice->fields['id'] ?? '' > 0) {
            ...
            if (isset($datas[Status::ADDED]) && $datas[Status::ADDED] == "true") {
                ...
                $pView->updateImgTabTitle(
                    "'img_ContractDay" . $_POST['fakeid_new_intervention'] . "'",
                    $this->getMessage(ElementType::INTERVENTION, Status::SAVED),
                    false
                );
                $pView->changeBtnName(
    ...
    {
        $restrict = [
            "`glpi_plugin_manageentities_contracts`.`entities_id`" => $_POST['entities_id'],
    ...
    public function storeDatasInSession($type, $object)
    {
        ...
        switch ($type) {
            case ElementType::ENTITY:
                $object->fields['name'] = $_POST['new_entity_name'] ?? "";
                $object->fields['comment'] = $_POST['new_entity_comment'] ?? "";
                $object->fields['phonenumber'] = $_POST['new_entity_phone'] ?? "";
                $object->fields['fax'] = $_POST['new_entity_fax'] ?? "";
                $object->fields['website'] = $_POST['new_entity_website'] ?? "";
                $object->fields['email'] = $_POST['new_entity_email'] ?? "";
                $object->fields['postcode'] = $_POST['new_entity_postcode'] ?? "";
                $object->fields['state'] = $_POST['new_entity_state'] ?? "";
                $object->fields['country'] = $_POST['new_entity_country'] ?? "";
                $object->fields['town'] = $_POST['new_entity_city'] ?? "";
                $object->fields['address'] = $_POST['new_entity_address'] ?? "";
                $object->fields['entities_id'] = $_POST['new_entity_entities_id'] ?? "";
            ...
            case ElementType::CONTRACT:
                ...
                if (isset($_POST['new_contract_date_begin']) && $_POST['new_contract_date_begin'] != "" && $this->isDateFormatOK(
                    $_POST['new_contract_date_begin']
                )) {
                ...
                if (isset($_POST['new_contract_date_end']) && $_POST['new_contract_date_end'] != "" && $this->isDateFormatOK(
                    $_POST['new_contract_date_end']
                )) {
            ...
            case ElementType::INTERVENTION:
                ...
                if (isset($_POST['new_intervention_begin_date']) && $_POST['new_intervention_begin_date'] != "" && $this->isDateFormatOK(
                    $_POST['new_intervention_begin_date']
                )) {
                    $object->fields['begin_date'] = date('Y-m-d', strtotime($_POST['new_intervention_begin_date']));
                } else {
                    $object->fields['begin_date'] = null;
                }
                if (isset($_POST['new_intervention_end_date']) && $_POST['new_intervention_end_date'] != "" && $this->isDateFormatOK(
                    $_POST['new_intervention_end_date']
                )) {
            ...
            case ElementType::CONTRACT_MANAGEMENT_TYPE:
                ...
                $object->fields['show_on_global_gantt'] = $_POST['show_on_global_gantt'] ?? 0;
    ...
    {
        $criPrice = new CriPrice();
        $criPrice->getFromDBByCrit([
            'plugin_manageentities_critypes_id' => $post['new_criprice_critype'],
    ...
    public function isDateFormatOK($date, $format = 'd-m-Y')
    {
    ...
    public function getContractDay($i = -1)
    {
        if ($i == -1) {
            ...
            return $this->contractdays[$i] ?? null;
        }
    }
    ...
    public function getCriPrice($tabIdInterv = -1, $idTypeInterv = -1)
    {
        if ($tabIdInterv == -1) {
            return null;
        } elseif ($idTypeInterv == -1) {
            return $this->contractdays['criprice'][$tabIdInterv] ?? null;
        } else {
            return $this->contractdays['criprice'][$tabIdInterv][$idTypeInterv] ?? null;
        }
    }
