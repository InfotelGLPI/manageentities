...
soft='GLPI - manageentities plugin'
version='1.1.0'
...
xgettext *.php */*.php --copyright-holder='Manageentities Development Team' --package-name='GLPI - Manageentities plugin' --package-version='2.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
