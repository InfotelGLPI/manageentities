...
xgettext *.php */*.php --copyright-holder='Manageentities Development Team' --package-name='GLPI - Manageentities plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
