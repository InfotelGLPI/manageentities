 ...
 */
function plugin_manageentities_MassiveActions(string $itemtype): array
{
    ...
    return [
        Contract::class . $sep . 'update_subscription_fields'
            => "<i class='ti ti-edit'></i>" . __s('Update subscription fields', 'manageentities'),
    ];
}
