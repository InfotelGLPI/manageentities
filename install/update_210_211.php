...
function update210to211()
{
    ...
    $migration->addField('glpi_plugin_manageentities_configs', 'choice_intervention', 'integer', ['value' => null]);
    $migration->addField('glpi_plugin_manageentities_configs', 'contract_states', 'text', ['value' => null]);
    $migration->addField('glpi_plugin_manageentities_configs', 'business_id', 'text', ['value' => null]);

    $migration->addField('glpi_plugin_manageentities_preferences', 'contract_states', 'text', ['value' => null]);
    $migration->addField('glpi_plugin_manageentities_preferences', 'business_id', 'text', ['value' => null]);
    $migration->addField('glpi_plugin_manageentities_preferences', 'companies_id', 'text', ['value' => null]);

    $migration->addField('glpi_plugin_manageentities_contractdays', 'comment', 'text');
    $migration->addField('glpi_plugin_manageentities_contracts', 'refacturable_costs', 'bool', ['value' => '0']);
