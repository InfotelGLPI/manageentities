...
define('PLUGIN_MANAGEENTITIES_VERSION', '4.2.21');
...
function plugin_init_manageentities()
{
    ...
    if (Session::getLoginUserID()) {
        ...
        // Display filters of the same dashboard (native ES module, delegated listener)
        $PLUGIN_HOOKS[Hooks::ADD_JAVASCRIPT_MODULE]['manageentities'][] = 'scripts/directhelpdesk-filters.js';
