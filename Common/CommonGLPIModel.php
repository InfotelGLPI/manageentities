...
{
    public const ERROR_ADD    = 'error_add';
    public const ERROR_READ   = 'error_read';
    public const ERROR_UPDATE = 'error_update';
    public const ERROR_DELETE = 'error_delete';
    public const ERROR_ALL    = 'error_all';
}
...
abstract class CommonGLPIModel
{
    ...
    abstract public function serializeInSession();
